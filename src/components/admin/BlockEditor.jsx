...
const BlockEditor = ({ block, onRemove, onUpdate, onMoveUp, onMoveDown, isFirst, isLast, toast }) => {
    ...
    // Fetched in sub-component now
    useEffect(() => {
        // Keeping this for other potential blocks or if logic changes back
    }, [block.type]);
    ...
    const getEnhancedInfo = (type, data) => {
        ...
        const gradients = {
            ...
            completesentence: 'from-indigo-400 to-blue-600',
    ...
    return (
        ...
        >
              ...
              {block.type === 'wordclassification' && (
               ...
               {/* --- WORD DETECTIVE BLOCK --- */}
               {block.type === 'worddetective' && (
                 <div className="space-y-6">
                    <div className="space-y-2">
                       <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Judul Permainan</label>
                       <input 
