...
import { Keyboard, ArrowLeft, RefreshCcw, CheckCircle2, AlertCircle, X, ChevronUp } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-xl border border-slate-200 dark:border-white/10 flex flex-col overflow-hidden">
        ...
        <div className={cn(
          ...
          {/* Header */}
          <div className={cn("text-center transition-all duration-500", showKeyboard ? "mb-4 md:mb-6" : "mb-8 md:mb-12")}>
            <div className="flex items-center justify-center gap-3 mb-2">
              <span className="text-xl md:text-2xl transition-all">✍️</span>
              <h1 className={cn(
                "font-black text-slate-900 dark:text-white uppercase tracking-tight transition-all",
                showKeyboard ? "text-xl md:text-2xl" : "text-2xl md:text-4xl"
              )}>
            ...
            >
              <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-3">
                <div className="flex items-center justify-between mb-1">
                   ...
                   <button onClick={() => setShowKeyboard(false)} className="p-1.5 hover:bg-slate-200 dark:hover:bg-white/10 rounded-lg transition-colors">
